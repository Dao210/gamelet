    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-700">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="max-w-2xl mx-auto mb-12">
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl p-8">
            ...
            <div className="text-center">
              <Link href="/nerd/game" className="inline-block bg-blue-500 hover:bg-blue-600 text-white font-bold py-4 px-8 rounded-xl text-lg transition-colors">
                Play Nerdle Now
              </Link>
            </div>
          </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-12">
          ...
          <div className="text-center">
            <div className="bg-gradient-to-br from-amber-100 to-orange-100 dark:from-amber-900/30 dark:to-orange-900/30 w-16 h-16 rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-lg">
        ...
        <div className="text-center mt-12">
          ...
          <Link href="/nerd/game" className="inline-block bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white font-bold py-4 px-8 rounded-xl text-xl transition-all">
